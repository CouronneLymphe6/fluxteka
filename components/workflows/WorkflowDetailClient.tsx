  ...
  return (
    ...
    >
      <h2 className="font-heading text-lg font-bold text-text-primary mb-4 flex items-center gap-2">
        <Star className="h-5 w-5 fill-accent-400 text-accent-400" /> Évaluer ce workflow
      </h2>
...
function SimilarWorkflows({ workflows, currentTool }: { workflows: SimilarWorkflow[]; currentTool: string }) {
  ...
  return (
    ...
    >
      <h2 className="font-heading text-lg font-bold text-text-primary mb-1 flex items-center gap-2">
        <LinkIcon className="h-5 w-5" /> Tu pourrais aussi aimer
      </h2>
...
/* ══════════════════════════════════════════════
   MAIN PAGE
══════════════════════════════════════════════ */
export default function WorkflowDetailClient({ initialWorkflow }: { initialWorkflow: any }) {
  const [workflow] = useState<WorkflowDetail>(initialWorkflow);
                ...
                <details className="group">
                  <summary className="flex cursor-pointer items-center justify-between gap-3 px-6 py-4 hover:bg-gray-50 transition-colors list-none">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-text-primary flex items-center gap-1.5"><Target className="h-4 w-4" /> Je veux automatiser sans coder</p>
                ...
                <details className="group">
                  <summary className="flex cursor-pointer items-center justify-between gap-3 px-6 py-4 hover:bg-gray-50 transition-colors list-none">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-text-primary flex items-center gap-1.5"><Zap className="h-4 w-4 text-emerald-600" /> Je veux apprendre en faisant</p>
                ...
                <details className="group">
                  <summary className="flex cursor-pointer items-center justify-between gap-3 px-6 py-4 hover:bg-gray-50 transition-colors list-none">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-text-primary flex items-center gap-1.5"><Wrench className="h-4 w-4" /> Je veux l&apos;intégrer dans mon système</p>
